...

      {
        ...
        if ($db->commit()){
            ...
            try {
                ...
                $email_body = $email_body . "        <span style=\"font-family:&#39;Open Sans&#39;,sans-serif;color:#1d1d1b;font-weight:400;font-size:14px\">Hola " . $insert_row[3] . "<br><br>";
                $email_body = $email_body . "          Te informamos que recibimos tu pago a través de paypal y  el equipo de logística esta procesando tu envío.<br><br>";
                $email_body = $email_body . " En cuanto este en camino te enviaremos el número de guía para que le puedas dar seguimiento. </span></td>";
                $email_body = $email_body . "        </tr>";
                $email_body = $email_body . "      <tr>";
                $email_body = $email_body . "        <td colspan=\"3\" valign=\"top\" style=\"font-family:&#39;Open Sans&#39;,sans-serif;color:#ff4c00;font-size:14px;font-weight:300;padding-top:14px\">";
                ...
                $mail->AddAddress($insert_row[10], $insert_row[10]);
                $mail->Subject = "We have received your payment";
